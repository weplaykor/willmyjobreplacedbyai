...
1. `taxonomy.json`
   ...
   - This is where occupation names and ids live.
...
Right now:
- the taxonomy has `62` detail roles
...
1. Expand `taxonomy.json`
   - Add more majors, mids, subs, and detail nodes.
...
For hierarchy expansion, use official occupation references as the authority for major and lower-level occupation naming.
